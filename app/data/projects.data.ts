export const projects = [
  ...
  },
  {
    ...
    description:
      "An package for the AI SDK that allows you to use locally running ollama models",
  ...
  },
  {
    ...
    description:
      "A high quality, real-time text-to-speech server that works with Home Assistant",
